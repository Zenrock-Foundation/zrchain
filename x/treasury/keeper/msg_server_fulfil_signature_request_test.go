...
func Test_msgServer_FulfilSignatureRequest(t *testing.T) {
	...
	var defaultSigRequest = types.SignRequest{
		...
		KeyringPartySignatures: [][]byte{[]byte("0TestSignatureTestSignatureTestSignatureTestSignatureTestSignatu")},
	}
	...
	}{
		{
			...
			wantSigReq: &types.SignRequest{
				...
				KeyringPartySignatures: [][]byte{
					[]byte("0TestSignatureTestSignatureTestSignatureTestSignatureTestSignatu"),
					[]byte("1TestSignatureTestSignatureTestSignatureTestSignatureTestSignatu"),
				},
			},
			wantErr: false,
		},
