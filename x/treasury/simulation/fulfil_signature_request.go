...
func SimulateMsgFulfilSignatureRequest(
	...
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []simtypes.Account, chainID string,
		...
		// TODO: Handling the FulfilSignatureRequest simulation

		return simtypes.NoOpMsg(types.ModuleName, sdk.MsgTypeURL(msg), "FulfilSignatureRequest simulation not implemented"), nil, nil
	}
}
