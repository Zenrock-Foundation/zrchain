...
func SimulateMsgUpdateWorkspace(
	...
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []simtypes.Account, chainID string,
		...
		// TODO: Handling the UpdateWorkspace simulation

		return simtypes.NoOpMsg(types.ModuleName, sdk.MsgTypeURL(msg), "UpdateWorkspace simulation not implemented"), nil, nil
	}
}
