...
func (k Keeper) MinCommissionRate(ctx context.Context) math.LegacyDec {
	...
	if params.MinCommissionRate.IsNil() {
		return types.DefaultMinCommissionRate
	}
...
func (k Keeper) SetParams(ctx context.Context, params stakingtypes.Params) error {
...
func (k Keeper) GetParams(ctx context.Context) (params stakingtypes.Params, err error) {
	store := k.storeService.OpenKVStore(ctx)
