...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'Z8github.com/zenrocklabs/zenrock/zrchain/v4/x/policy/types'
  ...
  _globals['_POLICYPARTICIPANT']._serialized_end=415
